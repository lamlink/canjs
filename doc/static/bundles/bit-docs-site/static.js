...
System.bundles = {"bundles/bit-docs-site/static.css!":["bit-docs-html-canjs@0.4.7#static/canjs.less!$less","bit-docs-prettify@0.1.1#prettify.less!$less","bit-docs-site@0.0.1#styles/styles.less!$less"]};
/*npm-utils*/
...
define('package.json!npm', [
    ...
    (function (loader, packages, options) {
        ...
        },
        {
            ...
            'globalBrowser': {},
            'browser': {},
            'resolutions': { 'bit-docs-html-canjs': '0.4.7' }
        },
        {
...
/*bit-docs-html-canjs@0.4.7#static/canjs*/
define('bit-docs-html-canjs@0.4.7#static/canjs', function (require, exports, module) {
    require('./canjs.less!');
    $ = require('jquery');
